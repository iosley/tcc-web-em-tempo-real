...
\begin{figure}[!htb]
	...
	\includegraphics[width=400px]{PollingVsWebsocket.png}
	\fonte{\citeonline{Wang2013}}
	\label{fig:pollingVSwebsocket}
\end{figure}

Segundo \citeonline{flanagan2011javascript}, não é seguro dar acesso a sockets TCP de baixo nível para o cliente, porem a API WebSockets define uma alternativa segura, permitindo que o cliente crie conexões bidirecionais por sockets com servidores que suportem o protocolo WebSocket.

\begin{figure}[!htb]
	\centering
	\caption{Navegadores com suporte para WebSockets}
	\includegraphics[width=400px]{Can_I_Use-Web_Sockets.png}
	\fonte{http://caniuse.com/\#feat=websockets}
	\label{fig:websocket}
\end{figure}
