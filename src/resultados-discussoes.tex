...
Ajax é uma mistura do antigo com o novo, porque as tecnologias já existentes são combinadas em técnicas que muito cou
O Javascript assíncrono e o XML (Ajax) 1 são algo antigo e algo novo, porque as tecnologias já existentes são usadas, mas novas porque combina essas tecnologias existentes em técnicas que muito poucas consideravam anteriormente. Simplificando, por causa do Ajax, uma nova geração de aplicações e idéias estão borbulhando na cena do desenvolvedor.
Uma definição muito breve do Ajax é a seguinte:
