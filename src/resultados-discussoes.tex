...
%Se uma resposta de transmissão contínua continuar por muito tempo, o navegador sofre de excesso de uso de memória. Vários milhares de mensagens sucessivas em uma única resposta podem trazer o Firefox de joelhos. Você pode corrigir facilmente esse problema simplesmente terminando a resposta após cada 100 mensagens (ou após um limite de bytes, como 50 KB) e criando uma nova solicitação nova (como uma pesquisa longa para cada mensagem) para mensagens subseqüentes.
