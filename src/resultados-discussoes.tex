...
Segundo \citeonline{flanagan2011javascript}, não é seguro dar acesso a soquete TCP de baixo nível para o cliente, porem a API WebSockets define uma alternativa segura, permitindo que o cliente crie conexões bidirecionais por soquetes com servidores que suportem o protocolo WebSocket.
